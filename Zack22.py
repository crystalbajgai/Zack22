...
pygame.display.set_caption('Zack22')
...
control_img = pygame.image.load('img/control.png')
song_img = pygame.image.load('img/song.png')
...
class Player():
    ...
    def update(self, game_over):
        ...
        if game_over == 0:
            ...
            screen.blit(gameover_img, (200, 400))
            if self.rect.y > 200:
                self.rect.y -= 5
    ...
    def reset(self, x, y):
        ...
        for num in range(1, 7):
            ...
            img_right = pygame.transform.scale(img_right, (48, 70))
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.transform.scale(blob, (35, 35))
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
class Lava(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.transform.scale(img, (tile_size, tile_size // 1.8))
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
restart_button = Button(screen_width // 2 - 50,
                        screen_height // 2 + 50, restart_img)
start_button = Button(screen_width // 2 - 350, screen_height // 2.4, start_img)
exit_button = Button(screen_width // 2 + 75, screen_height // 2.4, exit_img)
...
while run:
    ...
    if main_menu == True:
        ...
        if start_button.draw():
            main_menu = False
        screen.blit(main_img, (0, 40))
        screen.blit(control_img, (0, 525))
        screen.blit(song_img, (350, 850))
    else:
        world.draw()
